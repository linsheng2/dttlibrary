...
public class ImageUtil {
	public static Bitmap convert(Bitmap src, Config config) {
		...
		Bitmap dst = Bitmap.createBitmap(src.getWidth(), src.getHeight(), config);
		if (dst == null) {
			return null;
		}
	...
	public static void recycleDrawable(BitmapDrawable drawable) {
		if (drawable == null) {
			return;
		}
	...
	public static void recycleImageView(ImageView imageView) {
		...
		if (imageView.getDrawable() instanceof BitmapDrawable) {
			recycleDrawable((BitmapDrawable) imageView.getDrawable());
	...
	public static int readPictureDegree(String path) {
		...
		try {
			ExifInterface exifInterface = new ExifInterface(path);
			int orientation = exifInterface.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_NORMAL);
			Log.d("lufengwen", "orientation: " + exifInterface.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_NORMAL));
			switch (orientation) {
			case ExifInterface.ORIENTATION_ROTATE_90:
				degree = 90;
				break;
	 ...
	 * 
	 * @param bitmap
	 *            the input bitmap, presumably a 96x96 pixel contact thumbnail.
	 */
	 ...
	 * 
	 * @param source
	 *            input bitmap, whose width must be a power of 2
	 */
	...
	public static Bitmap createCustomShapeBitmap(Bitmap srcBitmap, Drawable shapeDrawable) {
		...
		if (srcBitmap != null) {
			...
			if (recycle && dstBitmap != null && !dstBitmap.isRecycled()) {
				dstBitmap.recycle();
				dstBitmap = null;
			}
		}
